	...
	Class Master extends DBConnection {
		...
		function save_appointment(){
			...
			$sql = "UPDATE `patient_list` SET id = '{$id}' WHERE id = '{$id}'";
			...
			if($save_inv){
				...
				$sql = "UPDATE `appointments` set date_sched = '{$date_sched}',patient_id = '{$patient_id}',`status` = '{$status}',`ailment` = '{$ailment}',`equipo` = '{$equipo}',`accesorios` = '{$accesorios}' where id = '{$id}' ";
